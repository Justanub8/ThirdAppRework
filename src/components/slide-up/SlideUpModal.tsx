...
import { BottomSheetFooter, BottomSheetModal, BottomSheetScrollView, BottomSheetView, BottomSheetFooterProps } from '@gorhom/bottom-sheet';
...
const SlideUpModal = React.forwardRef<BottomSheetModal, SlideUpModalProps>((
